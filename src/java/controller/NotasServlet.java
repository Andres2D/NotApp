...
public class NotasServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Notas estudiante = new Notas(nombre, apellido, carrera, nota1, nota2);
            NotasService notasService = new NotasService();
            estudiante.setPromedio(notasService.getPromedio(nota1, nota2));
            request.setAttribute("estudiante", estudiante);
            getServletContext().getRequestDispatcher("/WEB-INF/view/inicio.jsp").forward(request, response);
        }
    }
